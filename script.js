function initMap(){
    ...
    var positives;
    for (int i=0; i<50; i++){
      postives[i] = data[i].positive;
    }
    var negatives, deaths;
    // New map
    ...
    var markers = [
        {
            ...
            content:'<h1>Alabama death: <span id="death"></span></h1>'
        },
        {
        ...
        },
        {
            ...
            content:'Wyoming currently has ' + 1000000 + ' cases. There is a total recovery rate of ' + 100000 + ' people'
        }
    ];
